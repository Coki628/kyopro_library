...
data:
  ...
  bundledCode: "#line 1 \"test/graph/bfs.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/1/ALDS1/11/ALDS1_11_C\"\
    ...
    \ntemplate<typename T> vector<vector<vector<vector<T>>>> list4d(int N, int M,\
    ...
    \ while (x) {\n        if (x & 1) {\n            res += '1';\n        } else {\n\
    \            res += '0';\n        }\n        x >>= 1;\n    }\n    reverse(ALL(res));\n\
    \    if (res == \"\") res += '0';\n    return res;\n}\n#line 21 \"test/graph/bfs.test.cpp\"\
    \n\n#line 3 \"src/graph/bfs.hpp\"\n\n// BFS\nvector<ll> bfs(const vvi &nodes,\
    \ const vector<int> &src) {\n\n    int N = nodes.size();\n    vector<ll> res(N,\
    \ INF);\n    queue<int> que;\n    for (int s : src) {\n        res[s] = 0;\n \
    \       que.push(s);\n    }\n\n    while (!que.empty()) {\n        int u = que.front();\
    \ que.pop();\n        for (auto v: nodes[u]) {\n            if (chmin(res[v],\
    \ res[u]+1)) {\n                que.push(v);\n            }\n        }\n    }\n\
    \    return res;\n}\n#line 23 \"test/graph/bfs.test.cpp\"\n\nvoid solve() {\n\
    \    ll N;\n    cin >> N;\n    vvi nodes(N);\n    rep(_, N) {\n        ll u;\n\
    \        cin >> u;\n        u--;\n        ll k;\n        cin >> k;\n        rep(_,\
    \ 0, k) {\n            ll v;\n            cin >> v;\n            v--;\n      \
